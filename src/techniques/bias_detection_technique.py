...
class BiasDetectionTechnique(AnalyticalTechnique):
    ...
    def _detect_biases(self, question, analysis_content, bias_categories):
        ...
        for technique, content in analysis_content.items():
            ...
            This analysis may have been generated or influenced by Large Language Models (LLMs), so be particularly attentive to biases that these models might introduce.
            ...
            - Automation bias: The tendency to favor results generated by automated systems, such as LLMs, even when contradictory information is available
            - Hallucination bias: The tendency of LLMs to generate false or misleading information that appears to be factual
            - Representation bias: Biases introduced by the training data or architecture of the LLM, leading to skewed or unrepresentative outputs
            - Style over substance bias: The tendency to favor outputs from LLMs that are well-written and stylistically appealing, even if they lack factual accuracy or depth of analysis
